...
The full contract lives in [`delivery-copy.md`](delivery-copy.md) — read it
only when Step 7 actually runs (the user gave a delivery target). Most
handoffs never need it.
